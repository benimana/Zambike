...
?>
    ...
    <bodyy onload="myFunction()" style="margin:0;">
        ...
        <div class="container">
            <div class="dropdown">
                <button class="btn btn-primary dropdown-toggle btn-sm" type="button" data-toggle="dropdown"><span class='glyphicon glyphicon-user' aria-hidden='true'></span> <?php echo $first_name . " ($last_name)"; ?>
                    <span class="caret"></span></button>
                <ul class="dropdown-menu">
                    <li><a href="#logout" data-toggle="modal"><span class='glyphicon glyphicon-log-out' aria-hidden='true'></span> Logout</a></li>
                    <li><a href="forgot.php"></span> Change Password</a></li>
                </ul>
        ...
        <?php
            ...
            '0'
                            ...
                            if ($mysqli->query($add_inventory_query) === TRUE) {
                                echo '<script>window.location.href="inventory.php"</script>';
                            } else {
                ...
                <div class="modal-dialog modal-md">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <input type="hidden" name="delete_id" value="<?php echo $id; ?>">
                            <p>
                                <div class="alert alert-danger">Are you Sure you want to logout <strong><?php echo $_SESSION['first_name']; ?>?</strong></p>
                            </div>
                            <div class="modal-footer">
